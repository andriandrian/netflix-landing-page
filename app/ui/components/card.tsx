...
export default function Card({ title, description, icon, iconAlt }) {
    return (
        <div className="relative bg-gradient-to-r from-[#192144] to-[#210e17] h-fit md:h-72 lg:h-[325px] rounded-xl shadow-md w-full     md:w-full lg:w-1/4 px-2 py-4">
            <div className="p-4 lg:py-4 lg:px-2 ">
                <h1 className="text-2xl font-bold lg:max-w-[242px]">{title}</h1>
